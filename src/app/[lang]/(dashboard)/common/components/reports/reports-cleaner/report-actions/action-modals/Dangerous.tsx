...
import ToastTick from '../../../../../../../../../../public/icons/redToast.svg';
...
const Dangerous: FC<ClientDataProps> = ({ onClose, isOpen, data }) => {
  return (
    <CustomModal
      ...
      modalClass="p-0 m-0"
    >
      <div className="flex h-20 border-l-[10px] border-red-500 justify-between px-4">
        <div className="flex items-center gap-x-4">
          <h1 className="font-bold text-xl text-gray-400">Mark as Dangerous</h1>
