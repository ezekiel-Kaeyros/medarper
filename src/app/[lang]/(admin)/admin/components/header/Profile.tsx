    ...
    <div ref={domNode} className="flex  flex-col items-center relative">
      <AnimateClick>
        <Image
          ...
          src={Logo}
          className="shadow-md bg-slate-100 p-1 w-16 h-16 rounded-full"
          alt="Profile"
        />
      </AnimateClick>
      {toggle ? (
        <FadinOutAnimation>
          <div className="flex flex-col bg-white shadow-lg p-4 right-0 top-16 absolute rounded-md">
            <div className="font-bold px-2 text-sm">Signed in as</div>
            <div className="text-sm px-2">admin@medar.com</div>
