...
const PasswordField: React.FC<PasswordFieldProps> = ({ props }) => {
  ...
  return (
    <div className="relative w-full">
      ...
      <input
        className="appearance-none border-2 rounded w-full py-3 px-3 leading-tight border-gray-300 bg-gray-100 focus:outline-none focus:border-primaryColor focus:bg-white text-gray-700 pr-16 font-mono js-password"
        id="password"
